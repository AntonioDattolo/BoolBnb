...
@section('content')
	...
	<div class="jumbotron p-3 mb-4 rounded-3 container">
		<div class="vista col-12 d-flex ">
			<div class="col-6 d-flex justify-content-center">
				@if (Str::startsWith($selectedSuite->img, 'http'))
					<img class="p-3" src="{{ $selectedSuite['img'] }}">
				@else
					<img class="" src="{{ asset('/storage/' . $selectedSuite->img) }}">
				@endif
			</div>
			<div class="card-body col-lg-6 col-sm-12 p-5">

				<h3>Suite informations:</h3>
				<h4>
					<p>
